export const CONFIG = {
  ...
  // ---------------------------------------------------------------------------
  site: {
    url: "https://refat17.github.io",
    locale: "en_US",
    twitterHandle: "@refat_rahman",
  },
  ...
  // ---------------------------------------------------------------------------
  seo: {
    defaultTitle: "MD Refat Rahman | Full-Stack Developer & Software Engineer",
    titleTemplate: "%s | %n", // %s = page title, %n = DATA.name
    keywords:
      "MD Refat Rahman, Refat Rahman, Full-Stack Developer, Software Engineer, MSc Computer Science, Anglia Ruskin University, Cambridge UK, Python, Django, React, Next.js, TypeScript, Machine Learning, Deep Learning, Portfolio",
